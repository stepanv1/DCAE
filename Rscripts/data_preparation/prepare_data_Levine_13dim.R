...
files <- list.files("/mnt/f/Brinkman group/current/Stepan/RobinsonFlowComparison/benchmark_data_sets/attachments/Levine2015marrow13paperdata/CyTOF AML PhenoGraph Benchmark Data Set 1 (see Figs 2A-B, S2A-C and Data S1A-F)/fcs_files", pattern = "\\.fcs$", full.names = TRUE)
