...
#check data witjput transform
setwd("/mnt/f/Brinkman group/current/Stepan/RobinsonFlowComparison/benchmark_data_sets")
data_nt <- flowCore::exprs(flowCore::read.FCS('./Samusik_all_notransform.fcs', transformation = FALSE, truncate_max_range = FALSE))
lapply(as.data.frame(data_nt),min)
