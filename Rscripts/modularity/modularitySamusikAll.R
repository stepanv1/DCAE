...
#system.time(neighborMatrix <- find_neighbors(data=data, query=data, k=105+1, metric='L2'))
#dirname=paste0(RES_DIR_PHENOGRAPH, CALC_NAME)
#system(paste0('mkdir ', dirname))
...
k=45
edges = jaccard45
gr<-graph_from_data_frame(edges[,1:2], directed = F, vertices = NULL)
