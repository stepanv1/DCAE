...
files_truth <- list(
    Levine_32dim = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_Levine_32dim.txt"), 
    Levine_13dim = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_Levine_13dim.txt"), 
    Samusik_01   = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_Samusik_01.txt"), 
    Samusik_all  = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_Samusik_all.txt"), 
    Nilsson_rare = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_Nilsson_rare.txt"), 
    Mosmann_rare = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_Mosmann_rare.txt") 
    #FlowCAP_ND   = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_FlowCAP_ND.fcs"), 
    #FlowCAP_WNV  = file.path(MANUAL_FLOWSOM, "true_labels_flowSOM_FlowCAP_WNV.fcs")
)
