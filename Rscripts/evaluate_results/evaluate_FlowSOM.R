...
MANUAL_PHENOGRAPH <- "../../results/manual/FlowSOM"
RES_DIR_FLOWSOM <- "../../results/auto/FlowSOM"

DATA_DIR <- "../../benchmark_data_sets"

#load(paste0("../../results/auto/densityCut/", "densityCut_2016-12-2315:29:03", "/", 'densityCut.RData'))
...
png(filename = '../../plots/FlowSOM/FlowSOM_auto_Levine_13.png', width = 1440, height = 1000)
ncolors=length(unique(cl_tr[[i]]))
col_true=colorRampPalette(c("violet","blue",  "yellow", "orange", "green","red"))(ncolors)
names(col_true) = unique(cl_tr[[i]])
