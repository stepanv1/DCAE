...
encoderDiscrete = Model([x, neib, SigmaTsq, weight_neib], logits_y, name='encoder')
...
def custom_loss(x, x_decoded_mean, z_mean):
    ...
    #print(g_l)
    return 1*msew + loss_mmd + 1*contractive() - 1*g_l + 1* entropy(x, x_decoded_mean)
...
table(clus)
#encoder.save_weights('6clust_encoder_weightsWEBERCELLS_2D_MMD_CONTRACTIVEk30_2000epochs_LAM_0.001.h5')
import sklearn
...
plot([Scatter(x=x, y=y,
                ...
                text=clust,
                hoverinfo='text')], filename='Discrete2dPerplexityk30weighted2000epochs_LAM_0.001.html')
