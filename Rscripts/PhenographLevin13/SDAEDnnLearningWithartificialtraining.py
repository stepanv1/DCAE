...
brc0=Birch(threshold=0.5, branching_factor=50, n_clusters=24, compute_labels=True, copy=True)
brc0.fit(aFrame)
lbls0=brc0.predict(aFrame)

brc1= Birch(threshold=0.5, branching_factor=50, n_clusters=24, compute_labels=True, copy=True)
brc1.fit(x_test_vae)
