...
nb=find_neighbors(aFrame, k3, metric='euclidean', cores=50)
...
#with pymp.Parallel(num_cores-1) as p:
#    for i in inputs:
#        thread_list.append((p.thread_num, singleInput(i)))
...
#vae.set_weights(ae.get_weights())
...
#np.savetxt('/mnt/f/Brinkman group/current/Stepan/WangData/WangDataPatient/x_test_encBatch10_VAE_noCut.txt', x_test_enc)
