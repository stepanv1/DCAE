...
autoencoder.compile(optimizer='adam', metrics=['mean_square_error_NN', contractive])
print(autoencoder.summary())
print(encoder.summary())
print(decoder.summary())

history = autoencoder.fit([targetTr[0:172600,:], neibF_Tr[0:172600,:,:],  Sigma, weight_neibF[0:172600,:]],
                epochs=epochs, batch_size=batch_size, shuffle=True)#, show_accuracy=True,)#, callbacks=[CustomMetrics(), tensorboard])
