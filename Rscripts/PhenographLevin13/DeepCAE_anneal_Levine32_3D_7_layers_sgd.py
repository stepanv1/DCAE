...
coeffCAE = 1
epochs = 2000
ID = 'Levine32_anneal_MMD_01_3D_DCAE_h120_h16_hidden_7_layers_sgd'+ str(coeffCAE) + '_' + str(epochs) + '_kernelInit_tf2'
...
plt.show()
# tables
df_BORAI = pd.DataFrame({'Method':['DCAE', 'SAUCIE', 'UMAP'],  'manytoone': [0.1039, 0.1793, 0.1160], 'discontinuity': [0.0066, 0.0099, 0.0009]})
