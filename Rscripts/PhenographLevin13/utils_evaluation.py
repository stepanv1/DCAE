...
def neighbour_onetomany_scoregenerate_clusters_pentagon(z, idx, kmax=30, num_cores=16):
...
#num_noisy = 25; branches_loc = [3,4]; sep=3/2; pent_size= 2; k=2
def generate_clusters_pentagon(num_noisy = 25, branches_loc = [3,4], sep=3/2, pent_size= 2, k=2):
    ...
    :pent_size: circum2radius of pentagon
    :sep: distance to branches from the plane of pentagon
    :k: cluster size multiplier
    """
    d = 5 #number of informative dimensions
