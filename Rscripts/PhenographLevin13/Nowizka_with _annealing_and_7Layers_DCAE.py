...
embedding = np.load('Nowizka_' + 'embedSAUCIE_100000.npz')['embedding'] #TODO redo Nowizka
...
plt.legend()
plt.savefig(PAPERPLOTS  + 'Nowizka_' + ID+ 'performance_marker_similarity_score.png')
plt.show()
plt.clf()
