...
for i in range(3):
    for bl in list_of_branches:
        ...
        MSS0 = np.mean(MSS1[k,:])
        LSSS1 = npz_res['LSSS1']
        LSSS0 = np.mean(LSSS1[k, :])
        #discontinuity =np.mean(discontinuity)
        #manytoone= np.mean(manytoone)
...
plt.savefig(PLOTS +'k_'+str(k)+'_'+ "MSS_normalized_mean.eps", format='eps', dpi = 350)
plt.close()
...
g.set(ylim=(0, None))
g.legend(bbox_to_anchor=(1.02, 1), loc=2, borderaxespad=0.)
plt.savefig(PLOTS +'k_'+str(k)+'_'+ "LSSS_normalized_mean.eps", format='eps', dpi = 350)
plt.close()
...
g.set(ylim=(0, None))
g.legend(bbox_to_anchor=(1.02, 1), loc=2, borderaxespad=0.)
plt.savefig(PLOTS +'k_'+str(k)+'_'+ "MSS_k_20_normalized_mean.eps", format='eps', dpi = 350)
plt.close()
...
g.set(ylim=(0, None))
g.legend(bbox_to_anchor=(1.02, 1), loc=2, borderaxespad=0.)
plt.savefig(PLOTS +'k_'+str(k)+'_'+ "LSSS_k_20_normalized_mean.eps", format='eps', dpi = 350)
plt.close()
...
g.set(ylim=(0, None))
g.legend(bbox_to_anchor=(1.02, 1), loc=2, borderaxespad=0.)
plt.savefig(PLOTS +'k_'+str(k)+'_'+ "MSS_k_60_normalized_mean.eps", format='eps', dpi = 350)
plt.close()
...
g.set(ylim=(0, None))
g.legend(bbox_to_anchor=(1.02, 1), loc=2, borderaxespad=0.)
plt.savefig(PLOTS +'k_'+str(k)+'_'+ "LSSS_k_60_normalized_mean.eps", format='eps', dpi = 350)
plt.close()
