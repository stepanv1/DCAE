...
# subset from 1 patient
#IDX = patient_table[:,1]=='"patient2_Reference"'
#lbls = lbls[IDX]
#aFrame = aFrame[IDX]
#patient_table = patient_table[IDX,:]

# subset from reference patients
IDX = [True if "Reference" in x else False for x in patient_table[:,1]]
lbls = lbls[IDX]
aFrame = aFrame[IDX]
patient_table = patient_table[IDX,:]


# subset from all patients
...
def custom_loss(x, x_decoded_mean, z_mean):
    ...
    return msew + 1*loss_mmd + 1*contractive()
...
#earlyStopping=EarlyStoppingByValLoss( monitor='val_loss', min_delta=0.0000001, verbose=1, patience=10, restore_best_weights=True)
...
history = autoencoder.fit([targetTr[2000:172600,:], neibF_Tr[2000:172600,:],  Sigma[2000:172600], weight_neibF[2000:172600,:]],
                ...
                validation_data=([targetTr[0:2000,:], neibF_Tr[0:2000,:],  Sigma, weight_neibF[0:2000,:]], None) , #shuffle=True,
...
#encoder.save_weights('encoder_weightsWEBERCELLS_2D_MMD_CONTRACTIVEk30_20epochs_LAM_0.00001.h5')
...
plot([Scatter(x=x, y=y,
                ...
                text=clust,
                hoverinfo='text')], filename='Reference200epochs_LAM_early_stopping.html')
...
#m=10
    plot([Scatter(x=x, y=y,
                        ...
                        text=clust,
                        hoverinfo='text'
                        )], filename='Rererence2dPerplexityk30weighted100epochs_LAM_0.00001_' + markers[m] + '.html')
...
plot([Scatter(x=x, y=y,
                ...
                hoverinfo='text')], filename='small2D_Patient_Treatment_LAM_0.001.html')
...
plot([Scatter(x=x, y=y,
                ...
                hoverinfo='text')], filename='Reference_Patient_LAM_0.001.html')
...
plot([Scatter(x=x, y=y,
                ...
                text=patient_table[:,1],
                hoverinfo='text')], filename='small2dPerplexityk30weighted200epochs_Treatment_LAM_0.001.html')
