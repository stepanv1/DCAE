...
seed<-set.seed(12345)
CALC_NAME <- 'POSTPROCESSINGRW_vs_LOF'
...
xres<-xtable(PerfMeasuresAllsets,  caption = "Postprocessing tests results with Phenograph, 4 methods", digits=4, display=c('s', 's', 'fg','fg','fg'), include.rownames=FALSE, align = c("|c|c|c|c|c|"), label = "Phenograph_4methods")
