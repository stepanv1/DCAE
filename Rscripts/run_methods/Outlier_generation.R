#generate ouliers based 
# on 'Local Subspace-Based Outlier Detection using Global Neighbourhoods'
# https://arxiv.org/pdf/1611.00183.pdf
...
logP<-as.numeric(log(Ptrace$Piter[1:800,455]))
