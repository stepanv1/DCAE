...
xres<-xtable(PerfMeasuresAllsets,  caption = "Tests results with FLOCK", digits=4, display=c('s', 's', 'fg','fg','fg','fg', 'fg'), include.rownames=FALSE, align = c("|c|c|c|c|c|c|c|"), label = "FLOCK_Levine32")
