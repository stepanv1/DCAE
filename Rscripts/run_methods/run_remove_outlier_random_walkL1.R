...
JAC_DIR = '/mnt/f/Brinkman group/current/Stepan/RobinsonFlowComparisonALL/results/kk105L1'
files <- list(
  Levine_32dim = file.path(JAC_DIR, "j105Levine_32dim.txt"), 
  Levine_13dim = file.path(JAC_DIR, "j105Levine_13dim.txt"), 
  Samusik_01   = file.path(JAC_DIR, "j105Samusik_01.txt"), 
  Samusik_all  = file.path(JAC_DIR, "j105Samusik_all.txt")
  #Nilsson_rare = file.path(DATA_DIR, "Nilsson_rare.fcs"), 
  #Mosmann_rare = file.path(DATA_DIR, "Mosmann_rare.fcs"), 
  #FlowCAP_ND   = file.path(DATA_DIR, "FlowCAP_ND.fcs"), 
  #FlowCAP_WNV  = file.path(DATA_DIR, "FlowCAP_WNV.fcs")
