#Python call of PhenoGraph, using rPython 
...
seed<-set.seed(12345)
#CALC_NAME = 'DELETE'
CALC_NAME<-gsub("[[:space:]]", "",paste0('k=40_ ',Sys.time()))
kPnenoGraph=40
...
#######test of PhenoGraph call from R
python.exec('import phenograph; import numpy as np')
