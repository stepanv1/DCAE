...
# java -Xmx16G -cp "lib/*" vortex.gui2.frmMain
...
files <- list(
  ...
  Nilsson_rare = file.path(DATA_DIR, "Nilsson_rare_notransform.fcs"), 
  Mosmann_rare = file.path(DATA_DIR, "Mosmann_rare_notransform.fcs")
)
