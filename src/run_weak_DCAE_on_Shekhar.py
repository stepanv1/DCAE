'''
Runs DCAE with smaller lam on Shekhar data to check for subpopulations in Rod BC
'''
import timeit
import numpy as np
...
ID = 'weakDCAE' +  '_lam_'  + str(lam) + '_batch_' + str(batch_size) + '_alp_' + str(alp) + '_m_' + str(m)
